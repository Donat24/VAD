...
dataloader_train = DataLoader(dataset_train, batch_size=3, shuffle=True, pin_memory=True, num_workers=0)
dataloader_test  = DataLoader(dataset_test,  batch_size=4, shuffle=True, pin_memory=True, num_workers=0)